...
const StickerPeel = ({
  ...
  useEffect(() => {
    ...
    container.addEventListener('touchstart', on);
  ...
  return (
    <div className={`draggable ${className}`} ref={dragTargetRef} style={cssVars}>
      ...
      <div
        ...
        ref={containerRef}
        onMouseEnter={() => containerRef.current?.classList.add('is-hovered')}
        onMouseLeave={() => containerRef.current?.classList.remove('is-hovered')}
      >
        <div className="sticker-main">
          <div className="sticker-lighting" style={{ filter: `url(#${uid}-pointLight)` }}>
            <img src={imageSrc} alt="" className="sticker-image" draggable="false" onContextMenu={e => e.preventDefault()} />
          </div>
        </div>
        <div className="flap">
          <div className="flap-lighting" style={{ filter: `url(#${uid}-pointLightFlipped)` }}>
            <img src={imageSrc} alt="" className="flap-image" style={{ filter: `url(#${uid}-expandAndFill)` }} draggable="false" onContextMenu={e => e.preventDefault()} />
          </div>
        </div>
      </div>
    </div>
