...
const PROJECTS = [
  ...
  },
  {
    ...
    overview: [
      ...
      { en: "It isn't fully deployed, so this page is where the concept, interface and architecture live. Drop the screenshots or demo frames into the gallery below to bring it to life.",
        es: "No está desplegado del todo, así que esta página es donde viven el concepto, la interfaz y la arquitectura. Arrastra las capturas o frames de demo a la galería de abajo para darle vida." },
    ],
    highlights: [
  ...
  },
  {
    ...
    overview: [
      ...
      { en: "Still in progress. The screens below are placeholders shaped like a phone, so drop your real mockups in and the design speaks for itself.",
        es: "Aún en progreso. Las pantallas de abajo son espacios con forma de teléfono, así que arrastra tus mockups reales y el diseño habla por sí solo." },
    ],
    highlights: [
  ...
  },
  {
    ...
    overview: [
      ...
      { en: "A fun excuse to think about game loops, state and feel. Drop gameplay screenshots or a GIF into the gallery to show it in motion.",
        es: "Una excusa divertida para pensar en game loops, estado y feel. Arrastra capturas de gameplay o un GIF a la galería para mostrarlo en movimiento." },
    ],
    highlights: [
  ...
  },
  {
    ...
    overview: [
      ...
      { en: "This is where the visual side of how I think lives. Drop renders, turntables or animation stills into the grid below.",
        es: "Aquí vive el lado visual de cómo pienso. Arrastra renders, turntables o stills de animación a la grilla de abajo." },
    ],
    highlights: [
...
/* ---------- localized getters ---------- */
function getEXP(lang) { return window.L(EXP, lang); }
function getSKILLS(lang) { return window.L(SKILLS, lang); }
function getPROJECTS(lang) { return window.L(PROJECTS, lang); }
function getPROJECT(slug, lang) {
  const p = PROJECTS.find((x) => x.slug === slug);
  return p ? window.L(p, lang) : null;
}

Object.assign(window, { Icon, EXP, SKILLS, PROJECTS, getEXP, getSKILLS, getPROJECTS, getPROJECT });
