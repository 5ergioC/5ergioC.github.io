...
/* ---- DecryptText: scramble then resolve, char by char ----
   Time-based reveal (stepMs per character) so it reads at a consistent,
   watchable pace. onView=true defers the scramble until in view. */
const GLYPHS = "ABCDEFGHIJKLMNOPQRSTUVWXYZ!<>-_\\/[]{}=+*^?#&%";
function DecryptText({ text, className, stepMs = 62, delay = 0, as = "span", onView = false }) {
...
function ParticleField() {
  ...
  const theme = window.useTheme ? window.useTheme()[0] : "dark";
  useEffect(() => {
...
Object.assign(window, { DecryptText, ParticleField, Reveal, Magnetic, useSpotlight });
